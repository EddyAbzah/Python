...
def main():
    ...
    folderpath = r"M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa"
    # folderpath = r"M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut mid arc in dc+"
    # folderpath = r"M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut mid arc in dc-"
    ...
    for file in all_filespath:
        ...
        for index, fig in enumerate(fig_spectograms):
            ...
            fig.write_fig(f"1.{index}) Spectogram 8k photo {meas_sig[index]} {file_name} .png",hieght=4320  ,width=7680)
...
def main_run(folderpath):
    ...
    for file in all_filespath:
        ...
        for index, fig in enumerate(fig_spectograms):
            ...
            #                   ))
            fig.write_html(f"1.{index}) Spectogram {meas_sig[index]} {file_name} .html", auto_open=auto_open)
            fig.write_image(f"1.{index}) Spectogram photo {meas_sig[index]} {file_name} .svg", width=7680 , height=4320)
...
if __name__=='__main__':
    ...
    all_folders=[r'M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Fa-Mid',
                 r'M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Fa- dc-',
                    r'M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut dc- arc in dc+',
                    r'M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut dc- arc in dc-',
                 r"M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut dc- arc in mid",
                 r"M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut mid arc in mid",
                 r"M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut mid arc in dc+",
                 r"M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut mid arc in dc-",
                 r"M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut dc+ arc in dc+",
                 r"M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut dc+ arc in mid",
                 r"M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut dc+ arc in dc-",
    ...
    # all_folders=[r'M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Opt arcs and fa\Dut dc- arc in dc-']
    all_folders=[r'M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Fa-Mid',
                 r'M:\Users\HW Infrastructure\PLC team\ARC\Temp-Noam\Fa- dc-'
                 ]
