...
# pyinstaller --onefile --noconsole --icon "icon.png" "Keypress Simulator 04.py"
# pyinstaller --noconfirm --onedir --windowed --contents-directory "Keypress Simulator 04" --icon "transparent.png"  "Keypress Simulator 04.py"
