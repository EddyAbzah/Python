...
path_file_folder = r'M:\Users\HW Infrastructure\PLC team\ARC\Temp-Eddy\Digital_Record 11_06_23 14_05'
path_file_name = 'Scope_Rec006'
path_output_file_and_title = 'Spectrum 1kHz-260kHz'
# # Output:
first_column_is_x_axis = [False, np.linspace(1e3, 260e3, num=1001)]
first_step_is_plot_all = (False, 'All frequencies')
...
for plot_name, plot in df.items():
