...
def main():
    ...
    cut = False
    cut_to_label = ['CT Meas', 'Shunt Meas' ,'Vdc Meas']
    SPI=True
    ...
    Plot_Zero_span=True
    zero_span_arr = [800, 820, 840, 860, 870, 880, 890, 900, 910, 920, 930, 950, 970, 990]
