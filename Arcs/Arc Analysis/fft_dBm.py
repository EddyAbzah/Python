# -*- coding: utf-8 -*-
"""
Created on Wed Dec 30 17:20:18 2020
...
def main(): 
    csv_path_folder = r"C:\Users\eddy.a\Documents\AutomationConsole Scripts_Git\Infrastructure\PLC\Arc\Python\\"
    csv_file_name = "record_20210113_115634"
    csv_path_input_file = csv_file_name +".csv"
    ...
    csv_path_out_file_avg = csv_path_folder + csv_file_name +"_fft_n_samples="+str(n_samples)+"_AVG="+str(n_ffts)+".csv"
    csv_path_out_file_max = csv_path_folder + csv_file_name +"_fft_n_samples="+str(n_samples)+"_MAX="+str(n_ffts)+".csv" 
    ...
    s_df = pd.read_csv(csv_path,nrows = n_samples*n_ffts ,usecols=[0]).astype(float)
